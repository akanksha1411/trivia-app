...
//            db.beginTransaction();
            ...
            for (int i = 0; i < questions.size(); i++) {
              ...
              /*  String video = "";
                ...
                updateQuizOptions(options, item.getQuesId(), pageCalled);
     ...
     * @return
     */
    public boolean updateQuizOptions(List<NewGame.Options> optionsList, int quesId, int pageCalled) {
...
//            db.beginTransaction();
            ...
            CommonUtility.showActivity(mContext, "pageCalled", pageCalled, true, startQuiz, null);
        }
        //   closeDB(db);
        return true;
    }
