    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        try {
           ...
           /* if (position == 5) {
            ...
            final Leaderboard_New obj=new Leaderboard_New();
            row.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (is_won == 1) {
                        obj.openPrizesView(mDataset.getUid(), mDataset.getPname(), mDataset.getName(), mDataset.getPimgurl(), mDataset.getRank(), baseContext);
                    } else {
                    }
