...
public class PrizesExpandableListAdapter2 extends BaseExpandableListAdapter {
    ...
    public PrizesExpandableListAdapter2(Context context, List<String> listDataHeader,
