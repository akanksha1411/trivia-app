...
public class PrizesExpandableListAdapter3 extends BaseExpandableListAdapter {
    ...
    private NonScrollListView single_day_prizes;
    public PrizesItemsBaseAdapter itemsBaseAdapter;
    ...
    public PrizesExpandableListAdapter3(Context context, List<String> listDataHeader,
    ...
    public View getChildView(int groupPosition, final int childPosition,
        ...
        int generatedIndex = random.nextInt(maxIndex);*/
            ...
            if (convertView == null) {
                ...
                convertView = infalInflater.inflate(R.layout.prize_daily_child, null);
            }
    ...
    public View getGroupView(int groupPosition, boolean isExpanded,
        ...
        String headerTitle = (String) getGroup(groupPosition);
            ...
            if (convertView == null) {
                ...
                convertView = inflater.inflate(R.layout.game_parent, parent,false);
                }catch (Exception e){
                    e.printStackTrace();
                }
            }
