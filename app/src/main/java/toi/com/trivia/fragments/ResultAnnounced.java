...
public class ResultAnnounced extends Fragment implements View.OnClickListener, TriviaConstants {
    ...
    static TextView user_name, result_title, game_score, game_bonus, time_bonus, share_button, answers_button, total_score, archive_result_text;
    static Button play_button;
    static RelativeLayout result_layout;
    static View view;
    ...
    BroadcastReceiver networkStateReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (!CommonUtility.haveNetworkConnection(context)) {
                Snackbar.make(progressLayout, "No internet connection", Snackbar.LENGTH_SHORT).show();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        result_layout = (RelativeLayout) view.findViewById(R.id.result_layout);
    ...
    private void initToolbar() {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                getActivity().finish();
                //GA entry ANALYTICS
                CommonUtility.updateAnalyticGtmEvent(getActivity(),  GA_PREFIX + EXIT + "Result Announced", BACK_ARROW, TriviaConstants.CLICK);
            }
        });
    ...
    public void onClick(View view) {
        ...
        if (id == R.id.play_button) {
            ...
            shareResult();
            //GA ANALYTICS
            CommonUtility.updateAnalyticGtmEvent(context,  GA_PREFIX +"Result Announced", "Share Result", TriviaConstants.CLICK);
            //takeScreenShot();
        } else if (id == R.id.answers_button) {
            Intent intent = new Intent(context, AnswersActivity.class);
            CommonUtility.showActivity(context, "", 0, false, intent, null);

            CommonUtility.fetchPlayedGame(Integer.parseInt(items.getGameId()), getActivity(), UID);
            //GA ANALYTICS
            CommonUtility.updateAnalyticGtmEvent(context,  GA_PREFIX +"Result Announced", "Share Result", TriviaConstants.CLICK);
    ...
    public void beginPlayingGame(int mCurrentGamePlayed, String currentGameId) {
        ...
        if (mCurrentGamePlayed == DEFAULT_ONE) {
            ...
            //GA ANALYTICS
            CommonUtility.updateAnalyticGtmEvent(context,  GA_PREFIX +"Result Announced", "Play another game", TriviaConstants.CLICK);
            ...
            if (Integer.parseInt(currentGameId) != DEFAULT_ZERO) {
                ...
                //GA ANALYTICS
                CommonUtility.updateAnalyticGtmEvent(context,  GA_PREFIX +"Result Announced", "Play new game", TriviaConstants.CLICK);
            } else {
                //another game- Take to archieve
                // CommonUtility.fetchArchive(getActivity(), String.valueOf(UID), TriviaConstants.RESULT_OUT_SCREEN);
                Intent intent = new Intent(getActivity(), GameArchive.class);
    ...
    private void shareResult() {
        ...
        share.putExtra(Intent.EXTRA_STREAM, Uri.parse("file:///sdcard/trivia_result.jpg"));
