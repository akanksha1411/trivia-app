...
public class APICalls implements TriviaConstants {
     ...
     * @param map
     */
    public static void registerUser(final Context context, HashMap<String, String> map, final int type) {
     ...
     * @param pageCalled
     */
    public static void fetchNewGame(final Context context, HashMap<String, String> currentGameId, final int pageCalled) {
        ...
        newSubmitcall.enqueue(new Callback<Contents>() {
                      ...
                      /*  //Interstitial ads integration
                        ...
                        CommonUtility.requestNewInterstitial(mInterstitialAd, context);*/
                                                  ...
                                                  //StartQuiz.replaceFragmentHistory(new GameEnd(), TriviaConstants.SCREEN_TYPE, b, true, (StartQuiz) context);
                                              } else {
                                                  if (QuizScreen.pd != null)
                                                      QuizScreen.pd.dismiss();
                                                  saveMap(currentGameId);
    ...
    private static void saveMap(Map<String, String> inputMap) {
    ...
    public static void fetchLeaderBoard(final Context context, HashMap<String, String> map, final int isRefreshAdapter, String mode) {
                                                 ...
                                                 if (items.getStatus() == SUCCESS_RESPONSE) {
                                                   ...
                                                   /*  Bundle bundle = new Bundle();
                                                     ...
                                                     if (isRefreshAdapter == DEFAULT_ZERO) {
                                                         ...
                                                         leaderboardItemses = items;
                                                         Leaderboard.PlaceholderFragment.adapter.updateItem(rankingsList);
                                                         //Leaderboard.PlaceholderFragment.adapter.notifyDataSetChanged();
                                                         Leaderboard.PlaceholderFragment.initUI();
                                                     }

                                                     Leaderboard.PlaceholderFragment.progressLayout.showContent();
                                                 } else {
     ...
     * @param mode
     */
    public static void fetchLeaderBoardMonthly(final Context context, HashMap<String, String> map, final int isRefreshAdapter, String mode) {
        Log.d("fetchLeaderBoard called", "-----------------");
                                                 ...
                                                 if (items.getStatus() == SUCCESS_RESPONSE) {
                                                   ...
                                                   /*  Bundle bundle = new Bundle();
                                                     ...
                                                     if (isRefreshAdapter == DEFAULT_ZERO) {
                                                         ...
                                                         MonthlyLeaderboard.monthlyAdapter.updateItem(rankingsList);
                                                         MonthlyLeaderboard.monthlyAdapter.notifyDataSetChanged();
                                                         Leaderboard.mSelectedStartDate = String.valueOf(System.currentTimeMillis() / 1000);
                                                         Leaderboard.mSelectedEndDate = String.valueOf(System.currentTimeMillis() / 1000);
     ...
     * @param mode
     */
    public static void fetchLeaderBoardWeekly(final Context context, HashMap<String, String> map, final int isRefreshAdapter, String mode) {
        Log.d("fetchLeaderBoard called", "------------");
                                                 ...
                                                 if (items.getStatus() == SUCCESS_RESPONSE) {
                                                   ...
                                                   /*  Bundle bundle = new Bundle();
                                                     ...
                                                     if (isRefreshAdapter == DEFAULT_ZERO) {
                                                         ...
                                                         WeekLeaderboard.weeklyAdapter.updateItem(rankingsList);
     ...
     * @param map
     */
    public static void userResult(final Context context, HashMap<String, String> map) {
     ...
     * @param map
     */
    public static void triviaPrizes(final Context context, HashMap<String, String> map) {
        String mode = "";
                                        ...
                                        if (response.isSuccessful()) {
                                            try {
                                                ...
                                                if (items.getStatus() == SUCCESS_RESPONSE) {
                                                   ...
                                                   /* if (PrizesActivity.PlaceholderFragment.listAdapter != null) {
                                                        PrizesActivity.PlaceholderFragment.listAdapter.itemsBaseAdapter.updateItem(prizes.getPrizesss());

                                                        PrizesActivity.PlaceholderFragment.initUI();
                                                    }*/
                                                    /*if (PrizesActivity.WeekPrizesFragment.mAdapter != null) {
                                                        PrizesActivity.WeekPrizesFragment.mAdapter.updateItem(prizesItems.getPrizes());

                                                        PrizesActivity.WeekPrizesFragment.initUI();
                                                    }
                                                    if (PrizesActivity.MonthlyPrizesFragment.mAdapter != null) {
                                                        PrizesActivity.MonthlyPrizesFragment.mAdapter.updateItem(prizesItems.getPrizes());

                                                        PrizesActivity.MonthlyPrizesFragment.initUI();
                                                    }*/

                                                   /* if (PrizesActivity.DailyFragment.mAdapter != null) {
                                                        PrizesActivity.DailyFragment.mAdapter.updateItem(prizesItems.getPrizes());

                                                        PrizesActivity.DailyFragment.initUI();
                                                    }*/

                                                    /*if (PrizesWeek.listAdapter != null) {
                                                        PrizesWeek.listAdapter.itemsBaseAdapter.updateItem(prizesItemsWeekly.getPrizes());

                                                    }

                                                    if (PrizesMonth.listAdapter != null) {
                                                        PrizesMonth.listAdapter.itemsBaseAdapter.updateItem(prizesItemsMonthy.getPrizes());
                                                    ...
                                                    //CommonUtility.showMessageAlert(context, PRIZES_NOT_OUT);
     ...
     * @param map
     */
    public static void fetchPlayedGame(final Context context, HashMap<String, String> map) {
     ...
     * @param map
     */
    public static void fetchGameArchive(final Context context, HashMap<String, String> map) {
                                         ...
                                         if (response.isSuccessful()) {
                                             try {
                                                 ...
                                                 if (items.getStatus() == SUCCESS_RESPONSE) {
                                                     ...
                                                     GameArchive.initUI(archiveItems);
