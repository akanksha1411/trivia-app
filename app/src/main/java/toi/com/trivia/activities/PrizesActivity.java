...
import toi.com.trivia.utility.ui.DividerItemDecoration;
...
public class PrizesActivity extends AppCompatActivity implements TriviaConstants, PrizesDaily.OnFragmentInteractionListener, PrizesWeek.OnFragmentInteractionListener, PrizesMonth.OnFragmentInteractionListener {
    ...
    public static List<PrizesItems.Prizesss> prizesList = new ArrayList<>();
    ...
    protected void onDestroy() {
        ...
        CommonUtility.updateAnalyticGtmEvent(getApplicationContext(), GA_PREFIX + EXIT + "Prizes", "Back Press", CLICK);
    }
